    ...
    return (
        ...
        <div>
          <div className="flex flex-col items-center space-y-2">
            ...
            <h1 className="text-4xl font-bold">Thank Yo dear {session?.user?.name}!u !</h1>
            <p>Thank you for your interest! next step you have to place the product to near by post office .</p>
            <a
              ...
              <Link className="text-sm mt-3 text-right" href={"/final"}>
